...
--
-- Name: paralog_pair; Type: TABLE; Schema: public; Owner: diopt; Tablespace: 
--

CREATE TABLE paralog_pair (
    paralog_pairid integer NOT NULL,
...
ALTER TABLE public.paralog_pair OWNER TO diopt;

--
-- Name: paralog_pair_best; Type: TABLE; Schema: public; Owner: diopt; Tablespace: 
--

CREATE TABLE paralog_pair_best (
    speciesid1 integer NOT NULL,
    geneid1 integer NOT NULL,
    speciesid2 integer NOT NULL,
    geneid2 integer NOT NULL,
...
ALTER TABLE public.paralog_pair_best OWNER TO diopt;
...
--
-- Name: paralog_pair_best_unique; Type: CONSTRAINT; Schema: public; Owner: diopt; Tablespace: 
--

ALTER TABLE ONLY paralog_pair_best
    ADD CONSTRAINT paralog_pair_best_unique UNIQUE (geneid1, geneid2);


--
-- Name: paralog_pair_pkey; Type: CONSTRAINT; Schema: public; Owner: diopt; Tablespace: 
--

ALTER TABLE ONLY paralog_pair
    ADD CONSTRAINT paralog_pair_pkey PRIMARY KEY (paralog_pairid);
...
--
-- Name: paralog_pair__best_geneid1_geneid2_key; Type: INDEX; Schema: public; Owner: diopt; Tablespace: 
--

CREATE INDEX paralog_pair__best_geneid1_geneid2_key ON paralog_pair_best USING btree (geneid1, geneid2);


--
-- Name: paralog_pair_geneid1_geneid2_prediction_method_key; Type: INDEX; Schema: public; Owner: diopt; Tablespace: 
--

CREATE INDEX paralog_pair_geneid1_geneid2_prediction_method_key ON paralog_pair USING btree (geneid1, geneid2, prediction_method);
...
--
-- Name: paralog_pair; Type: ACL; Schema: public; Owner: diopt
--

REVOKE ALL ON TABLE paralog_pair FROM PUBLIC;
REVOKE ALL ON TABLE paralog_pair FROM diopt;
GRANT ALL ON TABLE paralog_pair TO diopt;
GRANT ALL ON TABLE paralog_pair TO PUBLIC;


--
-- Name: paralog_pair_best; Type: ACL; Schema: public; Owner: diopt
--

REVOKE ALL ON TABLE paralog_pair_best FROM PUBLIC;
REVOKE ALL ON TABLE paralog_pair_best FROM diopt;
GRANT ALL ON TABLE paralog_pair_best TO diopt;
GRANT ALL ON TABLE paralog_pair_best TO PUBLIC;
